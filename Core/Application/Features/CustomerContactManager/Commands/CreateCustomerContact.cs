...
public class CreateCustomerContactHandler : IRequestHandler<CreateCustomerContactRequest, CreateCustomerContactResult>
{
    ...
    public CreateCustomerContactHandler(
        IUnitOfWork unitOfWork, ICommandRepository<CustomerContact> repository, NumberSequenceService numberSequenceService
    ) => (_unitOfWork, _repository, _numberSequenceService) = (unitOfWork, repository, numberSequenceService);
