...
public class UpdateCustomerCategoryHandler : IRequestHandler<UpdateCustomerCategoryRequest, UpdateCustomerCategoryResult>
{
    ...
    public UpdateCustomerCategoryHandler(IUnitOfWork unitOfWork, ICommandRepository<CustomerCategory> repository) => (_unitOfWork, _repository) = (unitOfWork, repository);
