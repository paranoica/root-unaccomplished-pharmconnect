...
public class UserSeeder
{
    ...
    public async Task GenerateDataAsync()
    {
        ...
        {
            var email = $"{name.ToLower()}{domain}"; if (await _userManager.FindByEmailAsync(email) == null)
            {
                ...
                var role = RoleHelper.GetProfileRole(); if (!await _userManager.IsInRoleAsync(applicationUser, role))
